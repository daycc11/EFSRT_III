...
<div class="container mt-4">
    ...
    <form method="get" action="<%=request.getContextPath()%>/EstudianteServlet">
        ...
        <div class="row align-items-end mb-3">
            ...
            <div class="col-md-2 d-flex align-items-end">
                <a href="<%=request.getContextPath()%>/EstudianteServlet?accion=listar&origen=admin" class="btn btn-primary btn-buscar w-100">
    ...
    <div class="table-responsive mt-3">
        ...
        <div class="alert alert-info text-center">
            <i class="bi bi-info-circle-fill"></i> No se encontraron estudiantes registrados.
        </div>
        <% } %>
    </div>
</div>

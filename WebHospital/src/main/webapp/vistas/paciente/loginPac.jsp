...
<body
	...
	<div
		...
		<form class="space-y-6 mt-6"
			...
			<div class="mt-6 text-center">
				<a href="<%=request.getContextPath()%>/PacienteServlet?accion=add"
					class="text-sm text-primary hover:underline">¿No tienes una cuenta?
					Regístrate</a>
			</div>
		</form>
	</div>
	...
	%>
	<div
		class="bg-green-100 border border-green-400 text-green-700 px-4 py-3 rounded relative text-center mt-4"
		role="alert">

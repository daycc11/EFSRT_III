...
<div class="container mt-4">
    ...
    <div class="row mt-4 g-3">
        <div class="col-md-3">
            <div class="card card-option text-center p-3">
                ...
                <h6 class="card-title">Reporte Incidencia</h6>
                <a href="<%=request.getContextPath()%>/IncidenciaServlet?accion=listar" class="stretched-link"></a>
            </div>
        </div>
        ...
        <div class="col-md-3">
            <div class="card card-option text-center p-3">
                ...
                <h6 class="card-title">Reporte Estudiante</h6>
                <a href="<%=request.getContextPath()%>/EstudianteServlet?accion=listar&origen=admin" class="stretched-link"></a>
            </div>
        </div>
        ...
        <div class="col-md-3">
            <div class="card card-option text-center p-3">
                ...
                <h6 class="card-title">Reporte Docente</h6>
                <a href="<%=request.getContextPath()%>/DocenteServlet?accion=listar" class="stretched-link"></a>
            </div>
        </div>
    ...
    <div class="mt-4">
        <img src="<%=request.getContextPath()%>/img/admin_banner.png" 
             alt="Administración" 
             class="img-banner-admin">
    </div>
</div>
